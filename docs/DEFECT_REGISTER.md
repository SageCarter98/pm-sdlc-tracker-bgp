...
| IPA05 | `README.md` claimed linting was unconfigured (stale since PR#5 added Ruff to CI, 2026-09-20) and listed "No frontend" under known gaps (stale since WP11/WP13, 2026-09-20/21) | Medium (documentation) | 2026-09-22 (same document) | Working-tree edit this session (`README.md`), not yet committed | Not reviewed by Milton | N/A (documentation) — grep-confirmed both claims are removed and replaced with the accurate current state, including honest open sub-findings (IPA02/03/04) | Closed | 2026-09-24 |
